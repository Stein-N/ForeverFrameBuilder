...
L["ERRORS_HINT"] = "Errors from templates, properties and scripts. Each report contains the template, all properties and every script of the project – copy it into a bug report."
