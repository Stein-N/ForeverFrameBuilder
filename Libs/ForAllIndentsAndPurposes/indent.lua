...
if not IndentationLib.revision or revision > IndentationLib.revision then
    ...
    local arithmeticColor = "|c00D4D4D4"
    ...
    defaultColorTable[">="] = arithmeticColor
    defaultColorTable["~="] = arithmeticColor
    defaultColorTable["and"] = arithmeticColor
    defaultColorTable["or"] = arithmeticColor
    defaultColorTable["not"] = arithmeticColor
	defaultColorTable[","] = arithmeticColor
	defaultColorTable[";"] = arithmeticColor

	local logicColor2 = "|c00C586C0"
	defaultColorTable["function"] = logicColor2
	defaultColorTable["if"] = logicColor2
	defaultColorTable["then"] = logicColor2
	defaultColorTable["return"] = logicColor2
	defaultColorTable["end"] = logicColor2
